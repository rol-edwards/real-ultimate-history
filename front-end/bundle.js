...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.changes_made),expression:"!changes_made"}]},[_c('h1',[_vm._v("Edit person")]),_vm._v(" "),_c('figure',[_c('img',{attrs:{"src":'../images/' + _vm.id + '.jpg'}})]),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(!_vm.event_list_visible),expression:"!event_list_visible"}]},[_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.name),expression:"name"}],attrs:{"type":"text","id":"name"},domProps:{"value":(_vm.name)},on:{"input":function($event){if($event.target.composing){ return; }_vm.name=$event.target.value}}}),_vm._v(" "),_c('label',{attrs:{"for":"name"}},[_vm._v("Name")])]),_vm._v(" "),_c('div',[_c('label',{attrs:{"for":"dob"}},[_vm._v("Date of birth")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.dob.number),expression:"dob.number"}],attrs:{"type":"text","id":"dob"},domProps:{"value":(_vm.dob.number)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.dob, "number", $event.target.value)}}}),_vm._v(" "),_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.dob.era),expression:"dob.era"}],attrs:{"type":"radio","value":"BC","id":"BC"},domProps:{"checked":_vm._q(_vm.dob.era,"BC")},on:{"change":function($event){_vm.$set(_vm.dob, "era", "BC")}}}),_vm._v("BC"),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.dob.era),expression:"dob.era"}],attrs:{"type":"radio","value":"AD","id":"AD"},domProps:{"checked":_vm._q(_vm.dob.era,"AD")},on:{"change":function($event){_vm.$set(_vm.dob, "era", "AD")}}}),_vm._v("AD")])]),_vm._v(" "),(_vm.dob.era=='AD')?_c('div',[_c('label',{attrs:{"for":"dod"}},[_vm._v("Date of death (AD)")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.dod.number),expression:"dod.number"}],attrs:{"type":"text","id":"dod"},domProps:{"value":(_vm.dod.number)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.dod, "number", $event.target.value)}}})]):_c('div',[_c('label',{attrs:{"for":"dod"}},[_vm._v("Date of death ")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.dod.number),expression:"dod.number"}],attrs:{"type":"text","id":"dod"},domProps:{"value":(_vm.dod.number)},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.dod, "number", $event.target.value)}}}),_vm._v(" "),_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.dod.era),expression:"dod.era"}],attrs:{"type":"radio","value":"BC","id":"BC"},domProps:{"checked":_vm._q(_vm.dod.era,"BC")},on:{"change":function($event){_vm.$set(_vm.dod, "era", "BC")}}}),_vm._v("BC"),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.dod.era),expression:"dod.era"}],attrs:{"type":"radio","value":"AD","id":"AD"},domProps:{"checked":_vm._q(_vm.dod.era,"AD")},on:{"change":function($event){_vm.$set(_vm.dod, "era", "AD")}}}),_vm._v("AD")])]),_vm._v(" "),_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.bio),expression:"bio"}],attrs:{"type":"text","id":"bio"},domProps:{"value":(_vm.bio)},on:{"input":function($event){if($event.target.composing){ return; }_vm.bio=$event.target.value}}}),_vm._v(" "),_c('label',{attrs:{"for":"bio"}},[_vm._v("Biography")])]),_vm._v(" "),_c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.nation),expression:"nation"}],attrs:{"type":"text","id":"nation"},domProps:{"value":(_vm.nation)},on:{"input":function($event){if($event.target.composing){ return; }_vm.nation=$event.target.value}}}),_vm._v(" "),_c('label',{attrs:{"for":"nation"}},[_vm._v("Nationality")])]),_vm._v(" "),_c('div',[_c('select',{directives:[{name:"model",rawName:"v-model",value:(_vm.role),expression:"role"}],attrs:{"id":"cat"},on:{"change":function($event){var $$selectedVal = Array.prototype.filter.call($event.target.options,function(o){return o.selected}).map(function(o){var val = "_value" in o ? o._value : o.value;return val}); _vm.role=$event.target.multiple ? $$selectedVal : $$selectedVal[0]}}},[_c('option',{attrs:{"value":"Political"}},[_vm._v("Political")]),_vm._v(" "),_c('option',{attrs:{"value":"Military"}},[_vm._v("Military")]),_vm._v(" "),_c('option',{attrs:{"value":"Philosopher"}},[_vm._v("Philosophical")]),_vm._v(" "),_c('option',{attrs:{"value":"Religious"}},[_vm._v("Religious")])]),_vm._v(" "),_c('label',{attrs:{"for":"cat"}},[_vm._v("Primary role")])]),_vm._v(" "),_c('div',[_c('button',{directives:[{name:"show",rawName:"v-show",value:(!_vm.event_list_visible),expression:"!event_list_visible"}],on:{"click":function($event){_vm.date_checks(_vm.dateToNumber(_vm.dob), _vm.dateToNumber(_vm.dod), _vm.update_person)}}},[_vm._v("Submit")]),_vm._v(" "),_c('button',{directives:[{name:"show",rawName:"v-show",value:(_vm.event_list_visible),expression:"event_list_visible"}],on:{"click":_vm.amend}},[_vm._v("Amend")])])]),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.event_list_visible),expression:"event_list_visible"}]},[_c('h2',[_vm._v("Events")]),_vm._v(" "),_c('p',[_vm._v("Select from existing events during this person's lifetime")]),_vm._v(" "),_vm._l((_vm.events),function(event){return _c('div',[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.ticked_events[event.id]),expression:"ticked_events[event.id]"}],attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.ticked_events[event.id])?_vm._i(_vm.ticked_events[event.id],null)>-1:(_vm.ticked_events[event.id])},on:{"change":function($event){var $$a=_vm.ticked_events[event.id],$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.$set(_vm.ticked_events, event.id, $$a.concat([$$v])))}else{$$i>-1&&(_vm.$set(_vm.ticked_events, event.id, $$a.slice(0,$$i).concat($$a.slice($$i+1))))}}else{_vm.$set(_vm.ticked_events, event.id, $$c)}}}}),_vm._v(_vm._s(event.name)+" "+_vm._s(event.id)),_vm._v(" "),_c('input',{directives:[{name:"show",rawName:"v-show",value:(_vm.ticked_events[event.id]),expression:"ticked_events[event.id]"},{name:"model",rawName:"v-model",value:(_vm.roles[event.id]),expression:"roles[event.id]"}],attrs:{"type":"text","id":"role"},domProps:{"value":(_vm.roles[event.id])},on:{"input":function($event){if($event.target.composing){ return; }_vm.$set(_vm.roles, event.id, $event.target.value)}}}),_vm._v(" "),_c('label',{attrs:{"for":"role"}},[_vm._v("Role")])])}),_vm._v(" "),_c('button',{on:{"click":_vm.update_events}},[_vm._v("Submit")])],2),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.events_updated),expression:"events_updated"}]},[_c('form',{ref:"uploadForm",attrs:{"id":"uploadForm","method":"post","encType":"multipart/form-data"}},[_c('input',{attrs:{"id":"picture","type":"file","name":"pic"}}),_vm._v(" "),_c('input',{attrs:{"type":"submit","value":"Upload!"}})]),_vm._v(" "),_c('button',{on:{"click":_vm.finish}},[_vm._v("Finish")])])]),_vm._v(" "),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.changes_made),expression:"changes_made"}]},[_c('h1',[_vm._v("Changes made!")]),_vm._v(" "),_c('p',[_c('a',{attrs:{"href":"/#/person/" + _vm.id}},[_vm._v("Return to person")])])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
